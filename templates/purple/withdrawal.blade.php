					...
					<div class="bg-white">
						<div class="flex items-center justify-between mb-6">
							<div class="flex items-center gap-3">
								<h1 class="text-2xl font-bold text-brand-600">{{ __('withdrawal.title.page') }}</h1>
								<span class="bg-brand-100 text-brand-700 text-xs font-bold px-2.5 py-0.5 rounded-full">{{ $items->count() }}</span>
							</div>
						</div>
