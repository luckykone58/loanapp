...
<body class="min-h-screen flex items-center justify-center p-0 sm:p-6">
	<div class="w-full min-h-screen bg-white p-8 sm:p-10 rounded-none shadow-none sm:min-h-0 sm:max-w-md sm:rounded-3xl sm:border sm:border-gray-200 sm:shadow-xl">
        ...
        <p class="text-brand-teal text-base mb-2">You look a little loss</p>
        <h1 class="text-4xl sm:text-5xl font-extrabold text-brand-dark mb-4">Oops! Page Not Found</h1>
        <p class="text-brand-dark text-lg sm:text-xl max-w-3xl mb-10">The link may be broken or the page may have moved.</p>
        <div class="w-full max-w-lg mx-auto mb-12">
        <img src="/public/storage/error.svg" alt="404 Not Found Illustration">
        </div>
    </div>
</body>
</html> 
