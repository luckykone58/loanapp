...
<body class="bg-gray-50 text-gray-800">
	<div class="bg-gray-50">
		<div class="relative max-w-[500px] mx-auto min-h-screen flex flex-col bg-gray-50 shadow-2xl overflow-hidden">
			<div class="absolute top-0 left-0 right-0 h-72 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 rounded-b-[2.5rem] z-0"></div>
			...
			<main class="flex-1 pb-0 relative pb-8 px-2">
				<div class="relative z-10  p-4 space-y-6 top-[10px] pb-40">
					...
					<div class="mb-2 text-center">
						...
						<p class="text-blue-100 text-xs opacity-90">{{ __('contact-us.text.tagline') }}</p>
					</div>
					...
					@if(!empty($faqs))
					<h3 class="mt-2 text-blue-500">{{ __('contact-us.title.faqs') }}</h3>
					<div class="space-y-3">
