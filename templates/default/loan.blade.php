				...
				<div class="relative z-10 bg-white rounded-3xl shadow-lg p-4 space-y-6 top-[30px] pb-40 min-h-[500px]">
					...
					<div class="bg-white rich-content">
						...
						<div class="space-y-6">
							...
							<div>
								...
								<div id="loan-duration-options" class="grid grid-cols-4 gap-2">
									@foreach($monthOptions as $m)
										<button type="button" data-months="{{ $m }}" class="duration-btn px-3 py-2 rounded-lg border text-sm inline-flex items-center gap-2 {{ $m===$defaultMonths ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300' }}">
									...
									<div class="bg-white rounded-2xl shadow-2xl max-w-[740px] w-full max-h-[80vh] overflow-auto p-0 relative border border-gray-100">
										...
										<div class="p-5">
											...
											<div class="mt-6 mb-8 flex items-center justify-end gap-3">
												...
												<button type="button" id="confirm-submit" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition shadow-sm">
							...
							<div class="mt-4 mb-4">
								<button id="loan-apply-btn" type="button" class="w-full inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-3 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed">
