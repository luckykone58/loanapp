					...
					<div class="bg-white rich-content">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center gap-3">
								<h1 class="text-2xl font-bold text-blue-500">{{ __('notifications.title.page') }}</h1>
                                <!-- List Count Badge -->
                                <span id="list-count-badge" class="bg-blue-100 text-blue-700 text-xs font-bold px-2.5 py-0.5 rounded-full hidden">0</span>
                            </div>
