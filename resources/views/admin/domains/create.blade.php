...
<li>/</li>
<li class="text-slate-900 dark:text-white font-medium">Add</li>
@endsection
	...
	<form method="POST" action="{{ route('admin.domains.store') }}">
		...
		<div class="mb-4">
			...
			<div class="relative">
				...
				<input type="text" name="name" value="{{ old('name') }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent">
			</div>
		...
		<div class="mb-4">
			...
			<div class="relative">
				...
				<input type="text" name="host" value="{{ old('host') }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required placeholder="example.com">
			</div>
		...
		<div class="mb-4">
			...
			<div class="relative">
				...
				<input type="date" name="expired_date" value="{{ old('expired_date') }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent">
			</div>
