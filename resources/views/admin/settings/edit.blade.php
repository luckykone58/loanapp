	...
	<form method="POST" action="{{ route('admin.settings.update', $setting) }}">
		...
		<div class="mb-4">
			...
			<div class="relative">
				...
				<input type="text" name="name" value="{{ old('name', $setting->name) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
			</div>
		...
		<div class="mb-4">
			...
			<div class="relative">
				...
				<textarea name="value" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" rows="4">{{ old('value', $setting->value) }}</textarea>
			</div>
