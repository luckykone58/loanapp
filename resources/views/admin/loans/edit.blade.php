		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div>
				...
				<div class="relative">
					...
					<input type="text" value="{{ $loan->user?->username ?? $loan->user_id }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" disabled>
			...
			<div>
				...
				<div class="relative">
					...
					<input type="text" name="loan_number" value="{{ old('loan_number', $loan->loan_number) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
				</div>
			...
			<div>
				...
				<div class="relative">
					...
					<input type="number" step="0.01" name="amount" value="{{ old('amount', $loan->amount) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
				</div>
			...
			<div>
				...
				<div class="relative">
					...
					<input type="date" name="start_date" value="{{ old('start_date', $loan->start_date) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
				</div>
			...
			<div>
				...
				<div class="relative">
					...
					<input type="number" name="period" value="{{ old('period', $loan->period) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
				</div>
			...
			<div>
				...
				<div class="relative">
					...
					<input type="number" step="0.01" name="interest" value="{{ old('interest', $loan->interest) }}" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
				</div>
				...
				<div class="relative">
					...
					<select name="status" class="w-full border rounded pl-10 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#459699]/40 focus:border-[#459699] dark:bg-transparent" required>
						@foreach(['processing','approved','rejected','paid'] as $status)
							<option value="{{ $status }}" @selected(old('status', $loan->status)===$status)>{{ ucfirst($status) }}</option>
						@endforeach
					</select>
				</div>
